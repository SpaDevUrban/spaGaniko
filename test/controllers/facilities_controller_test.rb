...
class FacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post facilities_url, params: { facility: { address: @facility.address, description: @facility.description, latitude: @facility.latitude, longitude: @facility.longitude, title: @facility.title } }
    end
  ...
  test "should update facility" do
    patch facility_url(@facility), params: { facility: { address: @facility.address, description: @facility.description, latitude: @facility.latitude, longitude: @facility.longitude, title: @facility.title } }
