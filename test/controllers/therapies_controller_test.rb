...
class TherapiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create therapy" do
    assert_difference('Therapy.count') do
      post therapies_url, params: { therapy: { description: @therapy.description, name: @therapy.name, value: @therapy.value } }
    end
  ...
  test "should update therapy" do
    patch therapy_url(@therapy), params: { therapy: { description: @therapy.description, name: @therapy.name, value: @therapy.value } }
