...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { cpf: @administrator.cpf, email: @administrator.email, name: @administrator.name, phone1: @administrator.phone1, phone2: @administrator.phone2, surname: @administrator.surname } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { cpf: @administrator.cpf, email: @administrator.email, name: @administrator.name, phone1: @administrator.phone1, phone2: @administrator.phone2, surname: @administrator.surname } }
