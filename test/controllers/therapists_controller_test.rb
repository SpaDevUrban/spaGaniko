...
class TherapistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create therapist" do
    assert_difference('Therapist.count') do
      post therapists_url, params: { therapist: { cpf: @therapist.cpf, email: @therapist.email, name: @therapist.name, phone1: @therapist.phone1, phone2: @therapist.phone2, surname: @therapist.surname } }
    end
  ...
  test "should update therapist" do
    patch therapist_url(@therapist), params: { therapist: { cpf: @therapist.cpf, email: @therapist.email, name: @therapist.name, phone1: @therapist.phone1, phone2: @therapist.phone2, surname: @therapist.surname } }
